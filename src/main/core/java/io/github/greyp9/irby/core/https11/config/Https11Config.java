...
public class Https11Config extends Http11Config {
    ...
    public Https11Config(final String type, final String name, final String host, final int port,
                         final int threads, final long timeout,
        ...
        super(name, host, port, threads, timeout);
        this.type = type;
